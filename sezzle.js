...
var SezzleJS = function (options) {
	...
	// checking if an existing config is using widthType thin/thick - and keeping the same but updating to work with new version
	else if (document.sezzleConfig.widthType === 'thick' || document.sezzleConfig.widthType === 'thin') {
		switch (document.sezzleConfig.widthType) {
			case 'thick':
				if (options.hidePrice) {
					const thickTemplate = 'or ' + this.numberOfPayments + ' automatic, interest free payments with %%logo%% %%learn-more%%';
					this.widgetTemplate = thickTemplate.split('%%')
				} else {
					const thickTemplate = 'or ' + this.numberOfPayments + ' automatic, interest free payments of %%price%% with %%logo%% %%learn-more%%';
					this.widgetTemplate = thickTemplate.split('%%')
				}
				break;
			case 'thin':
				if (options.hidePrice) {
					const thinTemplate = 'or ' + this.numberOfPayments + ' automatic, interest free payments with %%logo%% %%learn-more%%';
					this.widgetTemplate = thinTemplate.split('%%')
				} else {
					const thinTemplate = 'or ' + this.numberOfPayments + ' automatic, interest free payments of %%price%% with %%logo%% %%learn-more%%';
					this.widgetTemplate = thinTemplate.split('%%')
				}
		}
	}
		...
		if (options.hidePrice) {
			const defaultWidgetTemplate = 'or ' + this.numberOfPayments + ' interest-free payments with %%logo%% %%info%%';
